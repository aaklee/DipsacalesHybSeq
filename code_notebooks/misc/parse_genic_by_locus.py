...
def main():
    ...
    fastas = "/projects/clement-lab/5-HybSeq/hybpiper_plastids/partition_extractions/genic/extracted_regions"
    tallies = "/projects/clement-lab/5-HybSeq/hybpiper_plastids/partition_extractions/genic/tallied_regions.txt"
